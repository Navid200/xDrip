...
The following requires that you access different xDrip settings pages as shown.  For example, Settings &#8722;> Less common settings means that you should tap on "Settings", from the top left menu button on the main screen.  Then, on the new page that opens, you should tap on "Less common settings".  
