...
Read (but, do not follow yet) the manufacturer's instructions for using the applicator.  
...
If you don't see any visible flaw, follow the manufacturer's instructions to insert the sensor.  
