...
1- Use `Settings` &#8722;> `Auto configure` to scan the QR code shown below.  
...
2- Insert the sensor.  Take note of the 4-digit pairing code shown on the sensor applicator.  
![](./images/G7_Applicator.png)  
  
3- Set up xDrip, and your phone, as explained [here](../G6-Recommended-Settings.md).  It is very important to go over the settings and confirm they are all correct.  The QR code you scanned does not do that.  

4- Make sure your old used G7 devices are out of range, or place them iside the microwave.  
  
5- Enter the 4-digit pairing code shown on the sensor applicator as the transmitter id.  
![](./images/DexG7ID.png)  
  
6- Go to the [G5/G6/G7 status page](../StatusG5G6.md), and wait for connection.  
