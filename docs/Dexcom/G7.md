...
Before inserting a new sensor, use a pen to mark your old one to ensure you won’t accidentally peel off the wrong sensor later.  
...
Take note of the 4-digit pairing code displayed on the sensor applicator, as you will need it to establish connectivity.  
...
4- [Scan the QR code](../Settings/Scan_QR_Code.md) shown below if you haven't already.  You don't need to do this for every sensor.  
