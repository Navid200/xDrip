...
1- If you have the Dexcom app (or any other app collecting from the sensor) installed, uninstall it.  Do not start your Dexcom receiver or pump yet.  If they're already running, disable them and wait 15 minutes.  
  
2- Go to Android Settings &#8722;> Connected devices.  
Forget all devices named DXCM\*\*,  DX01\*\* or DX02\*\*, where \*\* represents any two characters.  
  
3- Ensure xDrip is updated to at least the [2025.03.23](https://github.com/NightscoutFoundation/xDrip/releases/tag/2025.03.23) release.  
...
If xDrip is not scanning after pairing, Restart Collector. See [this](./G7OnceAMinuteScan.md) for details.  
<br/>  
