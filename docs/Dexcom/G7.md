...
While verifying that the sensor is not [damaged](./G7ApplicatorFailures.md), follow the the manufacturer's instructions to use the applicator to insert the sensor.  The session, on G7 or One+, will automatically start upon inserting the sensor.  
