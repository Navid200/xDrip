...
Have a look at [this](./Dexcom-Basics.md) basic information about using xDrip to control Dexcom if you haven't already.  And [this](./Dexcom_page.md) page with information specific to Dexcom devices.  
