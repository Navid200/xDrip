## Update xDrip  
[xDrip](../README.md) >> [Features](./Features_page) >> [Update xDrip](./Updates)
...
You can download the nightly builds (least tested but most recent), from "releases" under the "Releases" heading (shown below) on the [GitHub repository page](https://github.com/NightscoutFoundation/xDrip/).  
