---
title: "xDrip Update Check Issue: No New Updates Found"
description: "Explanation of why xDrip shows no action when checking for updates—only checks within your selected update channel, and shows a brief note if no newer release is available."
---
  
# Why nothing happens when I check for updates?
[xDrip](../) >> [Features](./Features_page.md) >> [Updates](./Updates.md) >> Why nothing happens when I check for updates?  
