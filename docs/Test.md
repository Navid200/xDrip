...
<button:hover style="background: linear-gradient(#121212, #121212); border: 1px solid #200000; box-shadow: inset 0px 0px 0px rgba(255,255,255,.3), 0px 0px 6px rgba(245,185,45,1); color: #f0f0f0;"></button:hover>
