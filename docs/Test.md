...
<button onclick="FunctionCopyText()" style="border-color:#ededed; color:#f0f0f0; background-color:#121212; margin-left:70px; padding:0; &:hover {box-shadow: inset 0px 0px 0px rgba(245,99,71,1), 0px 2px 15px rgba(245,99,71,1);}">Copy</button>
