...
<input type="text" value="curl https://raw.githubusercontent.com/jamorham/nightscout-vps/vps-1/bootstrap.sh | bash" size="80" id="myInputText" style="border-color:#ededed; background-color:#ededed">  
