...
![SnoozeFor](./Alerts/images/SnoozeFor.png)  
...
![GLA_DefaultSnooze](./Alerts/images/GLA_DefaultSnooze.png)  
...
![SnoozeNoActive](./Alerts/images/SnoozeNoActive.png)  
...
![PreemptiveSnoozeTime](./Alerts/images/PreemptiveSnoozeTime.png)  
...
![NotifOnLockScreen](./Alerts/images/NotifOnLockScreen.png)  
  
Choose the option that allows notifications to be shown.  
<br/>  
  
This should be all you need.  
But, if it doesn't work, in xDrip, enable `Settings` &#8722;> `Display` &#8722;> `Public Notifications`.  In that case, please [let me know](./Contact.md).  
