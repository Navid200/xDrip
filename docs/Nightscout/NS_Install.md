...
Now, we will install Linux on our [virtual machine](./NS_FreeTier), and Nightscout in it.  You must have [No IP](./noip_com.md) and [Google Project](./NS_GCProject.md) set up already to proceed.  
