...
Enter those.  Use the up and down arrow keys to move between the password and user ID fields.  Your FreeDNS user ID is shown at the top right corner of the page when you log into [FreeDNS](https://freedns.afraid.org/zc.php?from=L21lbnUv).  After you enter your user ID and password, youc an press enter to submit.  
