...
#### **Final Steps**  
After a successful setup, you will be prompted to enter an **email address for security notices**. Enter an email address, then confirm the **restart** when prompted.  
