## No IP registration  
[xDrip](../../README.md) >> [Features](../Features_page) >> [Nightscout](../Nightscout_page) >> [Nightscout on Google Cloud](./GoogleCloud) >> No IP registration  
...
You need to enter your email address, choose a password, and choose a hostname.  Make a note of all.  Make sure to create a hostname and not delay it to later.  
