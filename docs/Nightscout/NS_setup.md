...
We will now log into our new Nightscout, installed on the Google Cloud virtual machine, and set it up.  Everything we do in this step (explained on this page) is done on a regular web browser on your computer or mobile, and not in the virtual machine.   
