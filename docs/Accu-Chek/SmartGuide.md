...
![HardwareDataSourceSmartGuide](./images/HardwareDataSourceSmartGuide.png)  
  
4- From the main menu, tap on "System status".  Swipe left/right until you are on the SmartGuide status page.  
![SmartGuideStatusPage](./images/SmartGuideStatusPage.png)  
  
5- Tap on "Open".  You will be taken to the pairing page.  
![SmartGuidePairing](./images/SmartGuidePairing.png)  
...
![SmartGuideSerialNumber](./images/SmartGuideSerialNumber.png)  
  
8- When a pair request pops up, enter the 6-digit pin from the twist cap and approve pairing.  
![SmartGuidePin](./images/SmartGuidePin.png)  
