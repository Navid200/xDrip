...
This alert uses the same setting for override do not disturb from other alerts at `Settings` &#8722;> `Alarms and Alerts` &#8722;> `Other Alerts`.  That setting is at the very bottom of that page.  
<br/>  
